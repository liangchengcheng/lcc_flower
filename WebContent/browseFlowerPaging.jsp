...
<body>
 ...
 <br>数量<s:textfield size="4" name="quantity"></s:textfield>
			...
			<div style="clear: both">
				...
				<s:if test="#pager.hasPrevious">
					<a href="browseFlowerPaging.action?currentPage=
							<s:property  value="#pager.currentPage-1"/>">上一页
					</a>
				</s:if>
				<s:if test="#pager.hasNext">
					<a href="browseFlowerPaging.action?currentPage=
							<s:property  value="#pager.currentPage+1"/>">下一页
					</a>
				</s:if>
				<s:if test="#pager.hasLast">
					<a
						href="browseFlowerPaging.action?currentPage=
							<s:property  value="#pager.totalPage"/>">尾页
					</a>
				</s:if>
				<br> 当前第
